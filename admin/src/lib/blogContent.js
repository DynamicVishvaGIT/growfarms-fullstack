 ...
 *
 * This is the admin's copy of src/lib/blogContent.js. The two apps build
 * independently, so the rules are duplicated rather than shared; the point of
 * the duplicate is that the form's preview renders a body exactly the way the
 * website will. Any change here belongs in the website copy too.
 */
