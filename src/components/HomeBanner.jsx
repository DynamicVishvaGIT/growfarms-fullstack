...
// ─── Scroll budget ─────────────────────────────────────────────────────────────
// Total 500vh = 5 "scrolls" (100vh each).
const getPinHeight = () => "500vh"; 

const TOTAL_SCROLLS = 5;
const VIDEO_END   = 3 / TOTAL_SCROLLS; // Video takes the first 3 scrolls (0.0 to 0.6)
const CLOUD_START = VIDEO_END;         // Clouds start exactly when the video finishes
const CLOUD_RANGE = 2 / TOTAL_SCROLLS; // Clouds animate over the final 2 scrolls (0.6 to 1.0)
